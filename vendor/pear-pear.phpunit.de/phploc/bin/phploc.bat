...
set PHPBIN="C:\Web\skeleton\vendor\bin/composer-php.bat"
"C:\Web\skeleton\vendor\bin/composer-php.bat" "C:\Web\skeleton\vendor/pear-pear.phpunit.de/phploc/bin\phploc" %*
